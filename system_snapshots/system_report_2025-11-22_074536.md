# System Snapshot — 2025-11-22_074536

**Repo:** /home/igc/igc  
**Git branch:** main  
**Git SHA:** 9c55cb7e23b3300ee0ba26eaeb3253477f2be5ff  
...
Mem:            62Gi       1.6Gi       2.2Gi        25Mi        59Gi        61Gi
Swap:          8.0Gi       2.5Mi       8.0Gi
```
### Disk (root /)
```text
Filesystem      Size  Used Avail Use% Mounted on
/dev/nvme0n1p3  460G  8.9G  428G   3% /
```
### Disk (home ~)
```text
Filesystem      Size  Used Avail Use% Mounted on
...
### Last commit
```text
commit 9c55cb7e23b3300ee0ba26eaeb3253477f2be5ff
Author:     Andreas Bauer <andreas.e.bauer@gmail.com>
AuthorDate: Fri Nov 21 15:10:24 2025 +0100
Commit:     Andreas Bauer <andreas.e.bauer@gmail.com>
CommitDate: Fri Nov 21 15:10:24 2025 +0100

    Update GUI/services
```
### Status
```text
 M igc/gui/templates/metrics_select.html
 M igc/metrics/runner.py
 M igc/oe/core.py
?? igc/metrics/bundle.py
?? igc_repo_2025-11-21_1510.zip
```
...
httptools==0.7.1
idna==3.11
-e git+ssh://git@github.com/andreasebauer/IGCApp.git@9c55cb7e23b3300ee0ba26eaeb3253477f2be5ff#egg=igc
imageio==2.37.0
iniconfig==2.3.0
Jinja2==3.1.6
kiwisolver==1.4.9
