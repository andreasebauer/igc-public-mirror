# System Snapshot — 2025-11-13_074707

**Repo:** /home/igc/igc  
**Git branch:** main  
**Git SHA:** b584de8bf3c73daf306c5426e9b0ac03b1dece00  
...
Mem:            62Gi       2.5Gi        55Gi        25Mi       5.3Gi        60Gi
Swap:          8.0Gi       768Ki       8.0Gi
```
### Disk (root /)
```text
Filesystem      Size  Used Avail Use% Mounted on
/dev/nvme0n1p3  460G  8.1G  429G   2% /
```
### Disk (home ~)
```text
Filesystem      Size  Used Avail Use% Mounted on
...
### Last commit
```text
commit b584de8bf3c73daf306c5426e9b0ac03b1dece00
Author:     Andreas Bauer <andreas.e.bauer@gmail.com>
AuthorDate: Thu Nov 13 07:36:35 2025 +0100
Commit:     Andreas Bauer <andreas.e.bauer@gmail.com>
CommitDate: Thu Nov 13 07:36:35 2025 +0100

    Update GUI/services
```
### Status
```text
 M igc/gui/sim_flow.py
?? igc_repo_2025-11-13_0737.zip
```
...
httptools==0.7.1
idna==3.11
-e git+ssh://git@github.com/andreasebauer/IGCApp.git@b584de8bf3c73daf306c5426e9b0ac03b1dece00#egg=igc
imageio==2.37.0
Jinja2==3.1.6
kiwisolver==1.4.9
lazy_loader==0.4
